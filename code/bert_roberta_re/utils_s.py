...
entity2str = {'BOO':'书籍','JOB':'职官','PER':'人物','LOC':'地点','ORG':'机构'}
...
#         exit()
        if use_entity_indicator:
            ...
            e12_p = l-tokens_a[::-1].index("e")-1+1  # the end position ofentity1
            if 'm' not in tokens_a:
                print(example.text_a)
            e21_p = tokens_a.index("m")+1 -1  # the start position ofentity2
