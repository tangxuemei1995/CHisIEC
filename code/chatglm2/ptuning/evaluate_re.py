...
def each_class_f1(labels,y_pre,y_true,true_labels): 
        ...
        f2 = open('/ceph/home/jun01/tangxuemei/glm2/ptuning/output/cclue/re-128-2e-2/f1.txt','w',encoding='utf-8')
        labels = true_labels
        for x in test_f1s:
            if x in true_labels:
               microf1 += test_f1s[x]
...
if __name__=="__main__":
    eval_ner_alpaca('/ceph/home/jun01/tangxuemei/glm2/ptuning/output/cclue/re-128-2e-2/generated_predictions.txt')
